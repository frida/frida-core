...
namespace Frida {
	...
	public enum XnuMachTrap {
		IOKIT_USER_CLIENT = -101,
		DEBUG_CONTROL_PORT_FOR_PID = -97,
		MK_TIMER_ARM_LEEWAY = -96,
		MK_TIMER_CANCEL = -95,
		MK_TIMER_ARM = -94,
		MK_TIMER_DESTROY = -93,
		MK_TIMER_CREATE = -92,
		MACH_WAIT_UNTIL = -91,
		MACH_TIMEBASE_INFO = -90,
		_EXCLAVES_CTL = -89,
		MACH_PORT_REQUEST_NOTIFICATION = -78,
		MACH_PORT_TYPE = -77,
		MACH_VOUCHER_EXTRACT_ATTR_RECIPE = -73,
		HOST_CREATE_MACH_VOUCHER = -71,
		MACH_VM_RECLAIM_UPDATE_KERNEL_ACCOUNTING = -64,
		CLOCK_SLEEP = -63,
		THREAD_SWITCH = -62,
		SWTCH = -61,
		SWTCH_PRI = -60,
		PFZ_EXIT = -59,
		MACX_BACKING_STORE_RECOVERY = -54,
		MACX_BACKING_STORE_SUSPEND = -53,
		MACX_TRIGGERS = -52,
		THREAD_GET_SPECIAL_REPLY_PORT = -51,
		MACX_SWAPOFF = -50,
		MACX_SWAPON = -49,
		MACH_MSG2 = -47,
		PID_FOR_TASK = -46,
