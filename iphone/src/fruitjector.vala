public class Zid.Fruitjector : Object {
	...
	public async uint inject (int pid, string dylib_path, string data_string) throws IOError {
	...
	public extern uint _do_inject (int pid, string dylib_path, string data_string) throws IOError;
}
