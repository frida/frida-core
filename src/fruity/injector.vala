	...
	private sealed class Session : Object {
		...
		private async uint16 upload (Buffer buffer, ThreadedItems threaded_items, ChainedFixups chained_fixups,
			...
			config
				.begin_object ()
					...
					.set_member_name ("code_signing")
					.add_string_value ("optional")
				.end_object ();
			...
			var config_offset = args_builder.offset;
			apple_strv_builder
			...
			uint8  error_code                = (uint8)  ((listen_result >> 57) & 0x7f);
			bool   debugger_mapping_enforced =          ((listen_result >> 56) & 0x1) == 0 ? false : true;
			...
			if (debugger_mapping_enforced) {
				...
				yield lldb.write_byte_array (args + config_offset, new Bytes.static (overwrite_config_param.data), cancellable);
			}
		...
		private class UploadSymbols {
			...
			public UploadSymbols.from_set (SymbolSet symbols) throws Error {
				...
				munmap                = symbols.get (LIBSYSTEM, "_munmap");
		...
		private const uint8[] UPLOAD_LISTENER_CODE = {
			,
		...
		private const uint8[] UPLOAD_RECEIVER_CODE = {
			...
			
		};
