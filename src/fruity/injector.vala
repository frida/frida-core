namespace Frida.Fruity.Injector {
	...
	private class Session : Object {
		...
		private async GadgetDetails inject_module (Cancellable? cancellable) throws GLib.Error {
			...
			collect_needed_symbols (symbols_needed);
			...
			var gadget_port = yield upload (buffer, new UploadSymbols.from_set (symbols), cancellable);
		...
		private void collect_needed_symbols (SymbolQueryBuilder symbols_needed) throws GLib.Error {
			GLib.Error? pending_error = null;
			...
			Gum.FoundDarwinBindFunc collect_bind = bind => {
				...
				switch (bind.library_ordinal) {
					...
					case FLAT_LOOKUP:
					case WEAK_LOOKUP:
						pending_error = new Error.UNSUPPORTED ("Unsupported bind ordinal: %d", bind.library_ordinal);
						return false;
					default:
						break;
				}
				...
				symbols_needed.add (module_name, bind.symbol_name);
		...
		private async uint16 upload (LLDB.Buffer buffer, UploadSymbols symbols, Cancellable? cancellable) throws GLib.Error {
			...
			perform_upload.begin (buffer, listener_port, session_id_top, session_id_bottom, symbols, cancellable);
		...
		private async void perform_upload (LLDB.Buffer buffer, uint16 listener_port, uint64 session_id_top,
				uint64 session_id_bottom, UploadSymbols symbols, Cancellable? cancellable) {
			try {
		...
		private const uint8[] UPLOAD_RECEIVER_CODE = {
			
		};
