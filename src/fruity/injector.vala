namespace Frida.Fruity.Injector {
	...
	private class Session : Object {
		...
		private async GadgetDetails inject_module (Cancellable? cancellable) throws GLib.Error {
			...
			var gadget_port = yield upload (buffer, threaded_items.build (symbols), new UploadSymbols.from_set (symbols),
				cancellable);
		...
		private async uint16 upload (LLDB.Buffer buffer, ThreadedItems threaded_items, UploadSymbols symbols,
			...
			perform_upload.begin (buffer, threaded_items, listener_port, session_id_top, session_id_bottom, symbols,
				cancellable);
		...
		private async void perform_upload (LLDB.Buffer buffer, ThreadedItems threaded_items, uint16 listener_port,
				uint64 session_id_top, uint64 session_id_bottom, UploadSymbols symbols, Cancellable? cancellable) {
			try {
				...
				module.enumerate_init_pointers (ptrs => {
					construct_commands
						.append_uint8 (UploadCommandType.CONSTRUCT)
		...
		private const uint8[] UPLOAD_LISTENER_CODE = {
			...
			,
		...
		private const uint8[] UPLOAD_RECEIVER_CODE = {
			...
			
		};
		...
		private const uint8[] SYMBOL_RESOLVER_CODE = {
			...
			
		};
