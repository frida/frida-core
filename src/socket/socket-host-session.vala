namespace Frida {
	...
	public class SocketHostSessionProvider : Object, HostSessionProvider {
		...
		private class HostEntry : Object {
			...
			private Gee.HashMap<ChannelId?, ChannelStream> channel_streams =
				new Gee.HashMap<ChannelId?, ChannelStream> (ChannelId.hash, ChannelId.equal);
			...
			public void unlink_channel (ChannelId id) {
				ChannelStream? stream = channel_streams[id];
				if (stream != null)
					stream.abandon ();
			}
