...
namespace Frida.AXML {
	...
	const uint32 FLAG_UTF8 = 1 << 8;

	public class ElementTree : GLib.Object {
		public string name {
			get;
			set;
		}
		...
		public string to_string (int depth = 0) {
			...
			b.append ("<%s".printf (name));
			foreach (var attribute in attributes) {
				b.append (" %s=\"%s\"".printf (attribute.key, attribute.value.get_value ().to_string ()));
			}
			b.append (">\n");
	...
	private class EndElement : GLib.Object {
		public uint32 line;
		public uint32 comment;
		public uint32 namespace;
		public uint32 name;

		public EndElement.with_stream (DataInputStream input) throws IOError, GLib.Error {
	...
	public class ResourceValue : GLib.Object {
		private uint16 size;
		...
		internal ResourceValue.with_stream (DataInputStream input, StringPool string_pool) throws IOError, GLib.Error {
	...
	public class Attribute : GLib.Object {
		...
		internal Attribute.with_stream (DataInputStream input, StringPool string_pool) throws IOError, GLib.Error {
			namespace = input.read_uint32 ();
			name = input.read_uint32 ();
	...
	private class StartElement : GLib.Object {
			public uint32 line;
			public uint32 comment;
			public uint32 namespace;
			public uint32 name;
			...
			public StartElement.with_stream (DataInputStream input, StringPool pool) throws IOError, GLib.Error {
				line = input.read_uint32 ();
				comment = input.read_uint32 ();
				namespace = input.read_uint32 ();
				name = input.read_uint32 ();
	...
	private class Namespace : GLib.Object {
		public uint32 line;
		public uint32 comment;
		public uint32 prefix;
		public uint32 uri;

		public Namespace.with_stream (DataInputStream input) throws IOError, GLib.Error {
			line = input.read_uint32 ();
			comment = input.read_uint32 ();
	...
	private class ResourceMap : GLib.Object {
		private Gee.ArrayList<uint32> resources = new Gee.ArrayList<uint32> ();

		public ResourceMap.with_stream (DataInputStream input, uint32 size) throws IOError, GLib.Error {
	...
	private class StringPool : GLib.Object {
		private uint32 flags;
		private Gee.ArrayList<string> strings = new Gee.ArrayList<string> ();

		public StringPool.with_stream (DataInputStream input) throws IOError, GLib.Error {
	...
	public static ElementTree read (InputStream stream) throws Error, IOError, GLib.Error {
		...
		var namespaces = new GLib.Queue<Namespace> ();
		var root = new ElementTree ();
		var tree = new GLib.Queue<ElementTree> ();
		tree.push_head (root);
