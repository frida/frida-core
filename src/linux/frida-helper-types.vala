namespace Frida {
	public interface LinuxHelper : Object {
		...
		public abstract async void prepare_exec_transition (uint pid) throws Error;
		public abstract async void await_exec_transition (uint pid) throws Error;
		public abstract async void cancel_exec_transition (uint pid) throws Error;
		...
		public abstract async uint inject_library_file (uint pid, string path, string entrypoint, string data, string temp_path) throws Error;
