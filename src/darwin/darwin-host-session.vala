...
namespace Frida {
	...
	private class FruitLauncher {
		...
		private uint8[] generate_loader_plist () {
			 ...
			 * {
			 *   "Filter": {
			 *     "Bundles": ["com.apple.CoreFoundation"]
			 *   }
			 * }
			 */
			return new uint8[] {
				...
				0x10, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x70, 0x6c, 0x65, 0x2e, 0x43, 0x6f, 0x72, 0x65,
				0x46, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x08, 0x0b, 0x12, 0x15, 0x1d, 0x1f,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,
